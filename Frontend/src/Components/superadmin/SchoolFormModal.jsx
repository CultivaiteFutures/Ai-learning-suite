...
export default function SchoolFormModal({ isOpen, onClose, onSave, initialData }) {
  ...
  function validate() {
    ...
    if (!initialData) {
      ...
      if (formData.adminPassword && formData.adminPassword.trim().length < 6) {
        errs.adminPassword = "New password must be at least 6 characters";
      }
    }
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-sm font-medium text-slate-700">
                {initialData ? "Admin Password (leave blank to keep current)" : "Admin Password *"}
              </label>
              <button
                type="button"
              ...
              >
                <RefreshCw size={12} /> Auto-Generate Secure Password
              </button>
            </div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                placeholder={initialData ? "Enter new password to change" : "Enter or generate school admin password"}
