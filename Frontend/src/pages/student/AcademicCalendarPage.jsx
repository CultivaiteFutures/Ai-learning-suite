    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Holidays, exams, and deadlines for your school and enrolled courses.</p>
        </div>
        <CalendarSyncButton />
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white">
          <EmptyState
            title="No events yet"
            description="Holidays, exams, and deadlines from your school and courses will show up here."
            icon={CalendarDays}
          />
        </div>
      ) : (
