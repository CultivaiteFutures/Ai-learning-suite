...
export default function AnnouncementsPage() {
  ...
  const load = useCallback(() => {
    setLoading(true);
    Promise.all([announcementsAPI.list(), schoolAdminAPI.getCourses()])
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Share school-wide updates or notices scoped to a single course.</p>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white">
        ...
        <DataTable
          ...
          emptyDescription="Post your first school-wide or course announcement."
          emptyIcon={Megaphone}
        />
