...
/**
 * Read-only, same shared GET /announcements endpoint the student page uses --
 * app/api/v1/announcements.py scopes PARENT to school-wide announcements plus
 * anything posted to a course any of their linked children are enrolled in.
 */
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">School-wide notices and updates from your children's courses.</p>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white">
        {loading ? (
          ...
          <EmptyState
            ...
            description="Updates from your children's school and courses will show up here."
            icon={Megaphone}
          />
        ) : (
