...
export default function Sidebar({ isOpen, onClose }) {
  ...
  const navItems = NAVIGATION_CONFIG[(role || "").toLowerCase()] ?? [];
    ...
    <>
      ...
      >
        ...
        <div className="border-t border-slate-200 p-4">
          ...
          <div className="mt-1.5 flex flex-wrap gap-x-2 gap-y-0.5 text-[11px] text-slate-400">
            <Link to="/privacy-policy" className="hover:text-slate-600 hover:underline">Privacy</Link>
            <span>·</span>
            <Link to="/terms-of-service" className="hover:text-slate-600 hover:underline">Terms</Link>
            <span>·</span>
